...
class GitReleasePlugin : Plugin<Project> {
    ...
    fun configure(project: Project) {
        ...
        project.extensions.configure(GitPublishExtension::class.java) { gitPublish ->
            ...
            gitPublish.commitMessage = "Generated by gradle-git-release"
        ...
        project.extensions.configure(ReleaseExtension::class.java) { release ->
            release.preTagCommitMessage = "[Gradle Git Release Plugin] - pre tag commit: "
            release.tagCommitMessage = "[Gradle Git Release Plugin] - creating tag: "
            release.newVersionCommitMessage = "[Gradle Git Release Plugin] - new version commit: "
